...
// Contract contract1 = new Contract(employee1, Department.MARKETING,
// ContractType.PART_TIME,
// salary1, 20, startDate1, endDate1);
// this.contractRepository.save(contract1);
// this.contractList.add(contract1);

// Contract contract2 = new Contract(employee2, Department.SALES,
// ContractType.FULL_TIME, salary1,
