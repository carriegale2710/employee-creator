...
public class EmployeeService {
    ...
    private void checkEmail(String email, EmployeeRepository employeeRepository) throws EmailAlreadyExistsException {
        if (email != null && employeeRepository.existsByEmail(email)) {
            logger.warn("Email validation failed - Email already exists: {}", email);
    ...
    public Employee create(CreateEmployeeDTO dto) throws EmailAlreadyExistsException {
        ...
        logger.info("Employee saved to database with ID: {}", saved.getId());
        return saved;
    }
    ...
    public void deleteEmployeeById(Integer id) {
        ...
        logger.debug("Deleting contracts for employee ID: {}", id);
        ...
        logger.info("Employee and associated contracts deleted from database for ID: {}", id);
    }
    ...
    public Employee updateById(Integer id, UpdateEmployeeDTO dto) throws EmailAlreadyExistsException {
        ...
        logger.info("Employee updated in database with ID: {}", updated.getId());
        return updated;
    }
