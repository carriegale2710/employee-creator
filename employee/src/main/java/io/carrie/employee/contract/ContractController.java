...
public class ContractController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Contract> updateById(@PathVariable Integer id, @Valid @RequestBody UpdateContractDTO dto) {
        Contract editedContract = this.contractService.updateById(id, dto);
        return new ResponseEntity<>(editedContract, HttpStatus.OK);
    }
